# Wordlist Arcade: paste a vocab list, get six playable classroom games, unlimited and account-free (`wordlist-arcade`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://wordlist-arcade.sociobot.in`. Artifact class: `static-web`.
