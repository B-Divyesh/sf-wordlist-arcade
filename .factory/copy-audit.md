# Copy audit — 2026-08-28, polish round 3

The cold 390px first screen, full landing page, demo game toolbar, dynamic
long-link state, and README were read aloud. Every visitor-facing sentence has
22 words or fewer. No sentence uses a banned marketing word. Each observable
promise names its `.factory/claims.json` entry.
